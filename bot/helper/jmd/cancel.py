...
from bot.helper.jmd.utils.utils import (MirrorStatus, getAllDownload,
...
bot.add_handler(MessageHandler(cancel_mirror, filters=command(
    Commands.CancelMirror) & CustomFilters.authorized))
bot.add_handler(MessageHandler(cancell_all_buttons, filters=command(
    Commands.CancelAllCommand) & CustomFilters.authorized))
