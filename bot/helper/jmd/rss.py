...
from bot import (DATABASE_URL, LOGGER, bot, bot_name, config_dict, rss_dict,
                 scheduler)
from bot.helper.jmd.utils.utils import new_thread
from bot.helper.other.db import DbManger
from bot.helper.jmd.other.exceptions import RssShutdownException
from bot.helper.jmd.other.texts import RSS_HELP_MESSAGE
...
bot.add_handler(MessageHandler(getRssMenu, filters=command(
    Commands.RssCommand) & CustomFilters.authorized))
