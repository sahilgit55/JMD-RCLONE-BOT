...
from bot.helper.jmd.utils.utils import update_user_ldata
...
bot.add_handler(MessageHandler(authorize, filters=command(
    Commands.AuthorizeCommand) & CustomFilters.sudo))
bot.add_handler(MessageHandler(unauthorize, filters=command(
    Commands.UnAuthorizeCommand) & CustomFilters.sudo))
bot.add_handler(MessageHandler(addSudo, filters=command(
    Commands.AddSudoCommand) & CustomFilters.sudo))
bot.add_handler(MessageHandler(removeSudo, filters=command(
    Commands.RmSudoCommand) & CustomFilters.sudo))
